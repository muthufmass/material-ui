...
var TextField = React.createClass({
  ...
  render: function render() {
    ...
    var overrideStyle = _props.overrideStyle;

    var other = _objectWithoutProperties(_props, ['className', 'errorStyle', 'errorText', 'floatingLabelText', 'fullWidth', 'hintText', 'id', 'multiLine', 'onBlur', 'onChange', 'onFocus', 'type', 'rows', 'alignCenter', 'overrideStyle']);
    ...
    if (overrideStyle) styles = this.mergeStyles(styles, overrideStyle);
    ...
    var underlineElement = this.props.disabled ? React.createElement('div', { style: this.mergeAndPrefix(overrideStyle ? this.mergeStyles(styles.underlineAfter, overrideStyle.underlineAfter) : styles.underlineAfter) }) : React.createElement('hr', { style: this.mergeAndPrefix(overrideStyle ? this.mergeStyles(styles.underline, overrideStyle.underline) : styles.underline) });
